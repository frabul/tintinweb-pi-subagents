...
export const DEFAULT_AGENTS: Map<string, AgentConfig> = new Map([
  [
    "general-purpose",
    {
      ...
      // inheritContext / runInBackground / isolated omitted — strategy fields.
      // `runInBackground` is retained only for legacy config compatibility;
      // launches are always detached (see resolveAgentInvocationConfig).
      extensions: true,
      skills: true,
      systemPrompt: "",
      promptMode: "append",
