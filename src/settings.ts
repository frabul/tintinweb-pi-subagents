...
export interface SubagentsSettings {
   ...
   *     the orchestrator, listing the allowed models. The LLM made an explicit
   *     out-of-scope choice and gets explicit feedback; this override wins over
   *     any frontmatter `model:` default.
   *   - Frontmatter-pinned (when the caller omits `model`): warning toast + the
   *     pinned model runs. The agent's author/installer chose this; trust it.
